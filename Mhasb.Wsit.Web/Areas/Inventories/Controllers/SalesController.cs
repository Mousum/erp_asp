...
namespace Mhasb.Wsit.Web.Areas.Inventories.Controllers
{
    public class SalesController : Controller
    {
        ...
        [HttpPost]
        public ActionResult EditBill(string jsonData )
        {
        ...
        public ActionResult GetjsonItem(int Id)
        {
            ...
            var itemList = _itemService.GetAllItemsByConmanyId(companyId, Id)
                .Select(u => new
                {
                    ...
                    u.ItemCode,
                    u.ItemName,
                    Description = u.SalesDescription,
                    u.Quantity,
                    UnitPrice =u.SellUnitPrice,
                    AccountId = u.SalesAccount.Id,
                    AccountCode = u.SalesAccount.ACode,
                    AccountName = u.SalesAccount.AName,
                    PtxtValue = u.STaxRate.Key,
                    PtxtQuantity = u.STaxRate.Quantity,
                });
